    ...
    ui.vertical_centered(|ui| {
        ...
        .show(ui, |ui| {
            ...
            ui.horizontal_wrapped(|ui| {
                ...
                for pen in &mut app.state.color_palette.palette {
                    if app.state.color_palette.is_editing {
                        ui.vertical(|ui| {
                            ...
                            let button_image = ui.add_sized(
                                [32.0, 32.0],
                                egui::Button::image(icon).frame(false).fill(pen.color),
                            );
                ...
                let button_add =
                    ui.add_sized([32.0, 32.0], egui::Button::image(icon_add).frame(false));
                ...
                let icon_edit =
                    egui::Image::new(&app.icons.edit_pen).fit_to_exact_size(egui::vec2(32.0, 32.0));
                let button_edit =
                    ui.add_sized([32.0, 32.0], egui::Button::image(icon_edit).frame(false));
