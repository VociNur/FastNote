...
impl CurveRenderer {
    pub fn new(device: &wgpu::Device, target_format: wgpu::TextureFormat) -> Self {
        ...
        let max_subdivisions = 16usize;
        let max_vertices     = (max_points - 1) * max_subdivisions * 6;
        ...
        let render_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[wgpu::BindGroupEntry {
                binding: 0, resource: uniform_buffer.as_entire_binding(),
            }],
        });
...
impl egui_wgpu::CallbackTrait for CurveCallback {
    fn prepare(
        ...
        // Nombre total de threads = (n_points - 1) * subdivisions
        let n_segments = all_points.len().saturating_sub(1) as u32;
        let n_threads  = n_segments * subs;

        renderer.vertex_count = n_threads * 6;
        ...
        if all_points.len() >= 2 {
            ...
            compute_pass.dispatch_workgroups((n_threads + 63) / 64, 1, 1);
        }
